...
from allostatis.types import Variable, Node, Error, Data, Action, InverseFunction, IdentityFunction
...
if __name__ == "__main__":
    ...
    """
    prior_mu -> intero_mu
    intero_mu -> intero_data
    proprio_mu -> proprio_data
    proprio_mu -> intero_mu
    ...
    plot_values([prior, mu, data], ["Prior", "Mu", "Data"])
